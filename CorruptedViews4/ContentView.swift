            ...
            VStack {
                ...
                HStack(spacing: 20) {
                    Button(action: {
                        ...
                        Image(systemName                    .padding(.trailing)
                }
                        ...
                        Button(action: {
                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                Text("Access our comprehensive list of anti-racism resources, legal support, and mental health services.")
                                    ...
                                    .foregroundColor(.white: "Remember: the best confrontation is the one you avoid. Use this information to stay away from potential trouble spots."
                        )
