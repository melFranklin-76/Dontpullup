        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    Text("Together, we can work to create positive change. Below,mnb are resources to help educate, support, and take action against racism.")
                        .font(.body)
                        .foregroundColor(.white.opacity(0.8))
                    
                    // --- Add New Section for Anti-Hate --- 
                    ResourceSection(title: "Anti-Hate & Support Organizations", resources: [
                        Resource(
                            name: "Anti-Defamation League (ADL)",
                            description: "Fights antisemitism and all forms of hate.",
                            link: "https://www.adl.org"
                        ),
                        Resource(
                            name: "American Jewish Committee (AJC)",
                            description: "Advocates against antisemitism and promotes democratic values globally.",
                            link: "https://www.ajc.org"
                        )
                    ])
                    // --- End New Section ---
